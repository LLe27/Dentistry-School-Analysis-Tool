...
"}"));
        ...
        actionCSV_Editor = new QAction(MainWindow);
        actionCSV_Editor->setObjectName(QStringLiteral("actionCSV_Editor"));
        ...
        treeWidget->setGeometry(QRect(430, 20, 650, 401));
        QFont font;
...
"}"));
        ...
        dateEdit->setGeometry(QRect(605, 456, 121, 25));
...
"}"));
        ...
        dateEdit_2->setGeometry(QRect(825, 456, 121, 25));
...
"}"));
        ...
        btnDates->setGeometry(QRect(600, 600, 366, 61));
...
"}"));
        ...
        lblMin_2->setGeometry(QRect(604, 553, 47, 13));
        lblMin_2->setFont(font1);
        ...
        labelHyp_1->setGeometry(QRect(716, 510, 101, 20));
        ...
        labelHyp_2->setGeometry(QRect(716, 550, 101, 20));
...
"}"));
        ...
        label_6->setGeometry(QRect(600, 451, 141, 42));
...
""));
        ...
        comboBox->setGeometry(QRect(40, 630, 311, 22));
...
"}"));
        ...
        label_8->setGeometry(QRect(820, 451, 141, 42));
        label_8->setStyleSheet(QLatin1String("QLabel{\n"
"border-image: url(:/images/Label.png);\n"
"}"));
        label_7 = new QLabel(centralWidget);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(30, 620, 345, 61));
        label_7->setStyleSheet(QLatin1String("QLabel{\n"
"border-image: url(:/images/DisplayGraph.png);\n"
"}"));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(600, 500, 381, 111));
...
"}"));
        ...
        label_10->setGeometry(QRect(30, 580, 345, 41));
        QFont font2;
...
"}"));
        ...
        label_2->setGeometry(QRect(120, 20, 151, 31));
        QFont font3;
        ...
        menuWindow->addAction(actionCSV_Editor);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionCSV_Editor->setText(QApplication::translate("MainWindow", "CSV Editor...", 0));
        ...
        label_10->setText(QApplication::translate("MainWindow", "            Sort By Faculty Member", 0));
